...
<ul class="nav flex-column">
    <li class="nav-item">
        <a class="nav-link @if (View::getSection('active') === 'dashboard') active @endif" href="{{ route('delivery.dashboard') }}">
            <i class="bi bi-house-door me-2"></i>Assigned Orders
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link @if (View::getSection('active') === 'delivered') active @endif"
