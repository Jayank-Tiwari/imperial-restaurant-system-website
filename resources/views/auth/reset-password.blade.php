...
<head>
    ...
    <title>@lang('messages.reset_password') - @lang('messages.imperial_spice')</title>
    <!-- Fonts & Icons -->
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="position-relative mb-4">
                        <div class="form-floating">
                            <input type="email" name="email" class="form-control shadow-sm" id="email" placeholder="name@example.com" value="{{ $email ?? old('email') }}" required autofocus readonly>
                    ...
                    <div class="position-relative mb-4">
                        <div class="form-floating">
                            <input type="password" name="password" class="form-control shadow-sm" id="password" placeholder="New Password" required>
                    ...
                    <button type="submit" class="btn btn-brand py-3 rounded-3 fs-5 shadow w-100">
                        @lang('messages.reset_password') <i class="fas fa-check ms-2"></i>
                    </button>
                </form>
