                        ...
                        <div class="card-body">
                            ...
                            <?php if($isEligibleForDiscount ?? false): ?>
                                <div class="d-flex justify-content-between mb-2 bg-light text-success">
                                    ...
                                    <span>−<?php echo e(__('messages.currency')); ?><?php echo e(number_format($discountAmount, 2)); ?></span>
                                </div>
                            <?php endif; ?>
                            <hr>
                            <div class="d-flex justify-content-between fw-bold h5">
                                <span><?php echo app('translator')->get('messages.total'); ?>:</span>
                                <span id="total"><?php echo e(__('messages.currency')); ?><?php echo e(number_format($finalTotal ?? $total ?? 0, 2)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function updateSummaryForTab(tabType) {
                    const discountPercentage = <?php echo e($discountPercentage ?? 0); ?>;
                    const isEligibleForDiscount = <?php echo e($isEligibleForDiscount ? 'true' : 'false'); ?>;
