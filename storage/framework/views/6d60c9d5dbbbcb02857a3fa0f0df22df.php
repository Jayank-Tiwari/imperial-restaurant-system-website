...
<?php $__env->startSection('content'); ?>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color));">
        <div class="container text-center text-white">
            <h2 class="display-5 fw-bold mb-3"><?php echo app('translator')->get('messages.reserve_your_experience'); ?></h2>
            <p class="lead mb-4"><?php echo app('translator')->get('messages.book_your_table_2'); ?></p>
            <a href="<?php echo e(url('/booking')); ?>" class="btn btn-light text-primary fw-bold"
